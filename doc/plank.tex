...
commutativity). But then one might argue that, simply exchanging the $y$ for another $x$, also the
...
take care of that. A similar effect is present in the sort system where by using the rule S-P-ASSOC
it seems to be possible to arbitrarily nest $"{}"$.
