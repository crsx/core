...
\KR{Extra figure inserted without empty parentheses. It is much more readable…} \MS{I agree --- do
  you want me to drop the parentheses in every example? (I added explanations in
  Definition~\ref{def:syntax}.)} \KR{Yes!}
