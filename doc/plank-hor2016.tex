...
\item syntactic variables are used correctly;
  %CK: NOTE: this is the first time you refer to "syntatic variables";
  % it will leave the reader wondering what you're talking about!
...
\begin{figure*}[p]\small
  ...
  \begin{align}
    ...
    \tag{SP-Bind}
    %CK: Should that requirement instead be:
    % Δ'_{\op{var}}(\ov{w}) = \ov{S} ?
    %
    \\[1ex]
    %
    &\dfrac
...
The \thetag{SMC-*} rules handle contraction meta-terms.
%% 
\begin{enumerate}
